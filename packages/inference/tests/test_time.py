...
from repo_routing.time import cutoff_key_utc, dt_sql_utc, parse_dt_utc
...
def test_cutoff_key_utc_uses_stable_zulu_format() -> None:
    raw = datetime(2024, 1, 2, 3, 4, 5, tzinfo=timezone.utc)
    assert cutoff_key_utc(raw) == "2024-01-02T03-04-05Z"
